...
public class SimplePicture implements DigitalPicture {
    ...
    /**
     * A Constructor that takes no arguments. It creates a picture with a width of 200 and a height
     * of 100 that is all white. A no-argument constructor must be given in order for a class to be
     * able to be subclassed. By default all subclasses will implicitly call this in their parent's
     * no argument constructor unless a different call to super() is explicitly made as the first
    ...
    public Pixel[][] getPixels2D() {
        ...
        // loop through height rows from top to bottom
        for (int row = 0; row < height; row++)
            for (int col = 0; col < width; col++) pixelArray[row][col] = new Pixel(this, col, row);
    ...
    /**
     * Method to load the picture from the passed file name this just calls load(fileName) and is
    ...
    public void writeOrFail(String fileName) throws IOException {
        ...
        if (!fileLoc.canWrite()) {
            throw new IOException(
                    fileName
                            + " could not be opened. Check to see if you can write to the"
                            + " directory.");
        }
