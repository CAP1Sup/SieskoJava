 ...
 *
 * <p>Originally created for the Jython Environment for Students (JES). Modified to work with DrJava
 * by Barbara Ericson Also modified to show row and columns by Barbara Ericson
 *
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
    ...
    private void setUpNextAndPreviousButtons() {
        ...
        Icon nextIcon =
                new ImageIcon(DigitalPicture.class.getResource("rightArrow.gif"), "next index");
    ...
    private void createInfoPanel() {
        ...
        // create the font
        Font largerFont =
                new Font(infoPanel.getFont().getName(), infoPanel.getFont().getStyle(), 14);
    ...
    /**
     * Method to display the pixel information from the passed x and y but also converts x and y
     * from strings
     *
    ...
    public static void main(String args[]) {
        Picture pix = new Picture("Labs/PixLab/images/Red_Eyed_Tree_Frog_2.jpg");
        pix.explore();
    }
}
