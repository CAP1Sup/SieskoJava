...
public class StringOpsTester {
  ...
  public static void main(String[] args) {
    // instantiate a String object that represents your name. First, Middle and Last seperated by a
    // space. Store your name in a variable called fullName
    String fullName = "Christian Alexander Piper";
    ...
    System.out.println(
        "Last Name, First Name, Middle Initial is " + StringOps.lastFirstMidInitial(fullName));
    ...
    System.out.println(
        "The result when comparing the first name to the last name using Java's compareTo() method"
            + " is "
            + first.compareTo(last));

    // call the compareTo method after the +
    System.out.println(
        "The result when comparing the last name to the first name using Java's compareTo() method"
            + " is "
            + last.compareTo(first));

    // call the compareTo method after the +
    System.out.println(
        "The result when comparing the first name to the first name using Java's compareTo() method"
            + " is "
            + first.compareTo(last));
  }
}
