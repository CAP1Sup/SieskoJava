...
public class StringOps {
    ...
    // Write a static method called indexFirstSpace that takes a String called name as its formal
    // parameter.
    ...
    // Write a static method called indexSecondSpace that takes a String called name as its formal
    // parameter.
    ...
    // Write a static method called firstName that takes a String called name as its formal
    // parameter.
    // This method returns the first name.
    // precondition: name is of the form first name, middle name, last name. e.g. "Kawhi Anthony
    // Leonard"
    ...
    // Write a static method called lastName that takes a String called name as its formal
    // parameter.
    ...
    // Write a static method called middleName that 2takes a String called name as its formal
    // parameter.
    ...
    // Write a static method called lastFirstMidInitial that takes a String called name as its
    // formal
    // parameter.
    ...
    public static String lastFirstMidInitial(String name) {
        return (lastName(name)
                ...
                + firstName(name)
                + ", "
                + name.substring(indexFirstSpace(name) + 1, indexFirstSpace(name) + 2));
    }

    // Write a static method called firstNamePigLatin that takes a String called name as its formal
    // parameter.
    ...
    public static String firstNamePigLatin(String name) {
        ...
        if (index == -1) return "-1";
        // Take all characters after index (including index). Append all characters which are before
